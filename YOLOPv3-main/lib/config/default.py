...
# _C.DATASET.DATAROOT = '/media/zhanjiao/dataset/bdd/bdd100k/images/100k'       # the path of images folder
# _C.DATASET.LABELROOT = '/media/zhanjiao/dataset/bdd/bdd100k/labels/100k'      # the path of det_annotations folder
# _C.DATASET.MASKROOT = '/media/zhanjiao/dataset/bdd/bdd_seg_gt'                # the path of da_seg_annotations folder
# _C.DATASET.LANEROOT = '/media/zhanjiao/dataset/bdd/bdd_lane_gt'               # the path of ll_seg_annotations folder


_C.DATASET.DATAROOT = '/mnt/BDD/images'       # the path of images folder
_C.DATASET.LABELROOT = '/mnt/BDD/det_annotations'      # the path of det_annotations folder
_C.DATASET.MASKROOT = '/mnt/BDD/da_seg_annotations'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = '/mnt/BDD/ll_seg_annotations'               # the path of ll_seg_annotations folder
